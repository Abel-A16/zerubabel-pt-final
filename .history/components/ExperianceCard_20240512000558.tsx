...
function ExperienceCard({experience}: Props) {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-2 h-[50px] flex-shrink-0 w-[500px]
     ...
     cursor-pointer transition-opacity duration-200 overflow-hidden">
      <motion.img
        ...
        viewport={{ once: true }}
        className="w-32 h-36 rounded-full xl:rounded-full object-cover object-center"
