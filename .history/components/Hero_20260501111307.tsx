...
function Hero({ pageInfo }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-[#174D38]/5" />

      {/* Profile Image with Glow Effect */}
      <div className="absolute top-8 right-8 z-20">
        <div className="relative group">
          <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-[#174D38] to-[#4D1717] opacity-50 blur-md group-hover:opacity-100 transition duration-500" />
          <div
