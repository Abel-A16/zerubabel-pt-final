...
function Skills({skills}: Props) {
  return (
    ...
    text-center md:text-left xl:flex-row max-w-[2500px] 
    ...
    items-center
     '>
        ...
        <div className='mt-5 lg:mt-11 md:mt-12 2xl:m-36 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 w-full'>
