    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 2px 2px, #4a4a4a 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          <span
            className="inline-block px-4 py-1.5 rounded-full text-xs md:text-sm font-medium border mb-6"
            style={{
