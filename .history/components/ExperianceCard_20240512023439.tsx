...
function ExperienceCard({experience}: Props) {
  return (
    <article className=" snap-mandatory flex flex-col rounded-lg items-center space-y-2 h-screen flex-shrink-0 w-[500px]
     ...
     cursor-pointer transition-opacity duration-200 overflow-hidden">
      ...
      <div className=" md:ml-1  px-0 md:px-10">
        ...
        <ul className="list-disc space-y-2 text-lg ml-5 overflow-y-scroll scrollbar-thin scrollbar-thumb-[#778A35]/80 ">
