...
function ContactMe({ }: Props) {
    ...
    return (
        <div className='min-h-screen flex relative flex-col text-center md:text-left md:flex-row sm:flex-col w-full max-w-5xl justify-evenly mx-auto items-center px-5 py-10'>
            <Title text={'Contact'} />

            <div className='flex flex-col space-y-5'>
                <h4 className='text-4xl md:text-5xl font-semibold text-center'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 w-full max-w-xl mx-auto'>
                    <div className='flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2'>
                        <input {...register('name')} placeholder='Name' className='contactInput' type="text" />
                        <input {...register('email')} placeholder='Email' className='contactInput' type="email" />
                    </div>
                    <input {...register('subject')} placeholder='Subject' className='contactInput' type="text" />
                    <textarea {...register('message')} placeholder='Message' className='contactInput h-32 resize-none' />
                    <button
                        type='submit'
