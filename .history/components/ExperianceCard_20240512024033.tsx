    ...
    <article className=" snap-mandatory flex flex-col rounded-lg items-center space-y-2 h-[550px] flex-shrink-0 w-[500px]
     ...
     cursor-pointer transition-opacity duration-200 overflow-hidden">
      <motion.img
        ...
        viewport={{ once: true }}
        className="w-32 h-32 rounded-full xl:w- object-cover object-center"
      ...
      <div className="  px-0 md:px-10">
        ...
        <ul className="list-disc space-y-2 text-lg ml-5 max-h-96 overflow-y-scroll scrollbar-thin scrollbar-thumb-[#778A35]/80 ">
