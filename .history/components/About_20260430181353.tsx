...
export default function About({pageInfo}:Props)  {
  return (
    ...
    max-w-7xl px-6 md:px-10 py-10 justify-evenly mx-auto items-center'>
        <Title text={'About'}/>
        <motion.img
            initial = {{
                x: -200,
            ...
            className='mt-28 md:mt-0 md:mb-0 w-56 h-56 object-cover rounded-full
             md:rounded-lg md:w-72 md:h-72 xl:w-[350px] xl:h-[400px]'
        />
