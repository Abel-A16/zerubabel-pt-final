...
function ExperienceCard({experience}: Props) {
  return (
    <article className=" snap-mandatory flex flex-col rounded-lg items-center space-y-2 h-[550px] flex-shrink-0 w-[00px]
     md:w-[500px] xl:w-[700px] snap-center bg-[#292929] p-3 hover:opacity-100 opacity-40 
     cursor-pointer transition-opacity duration-200 overflow-hidden">
      ...
      <div className="  px-0 md:px-10">
        ...
        <ul className="list-disc space-y-2 text-lg ml-5 
                      ...
                      scrollbar-thin scrollbar-thumb-[#778A35]/80 ">
