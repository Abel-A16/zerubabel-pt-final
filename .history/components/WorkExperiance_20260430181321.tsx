...
function WorkExperiance({experiences}: Props) {
  ...
  whileInView={{
    ...
    className='flex flex-col relative min-h-screen overflow-y-hidden text-left md:flex-row 
    max-w-full px-5 md:px-10 justify-evenly mx-auto items-center'>
        <Title text={'Experience'}/>
        <div className='w-full flex space-x-5 overflow-x-scroll mt-24 snap-x snap-mandatory
