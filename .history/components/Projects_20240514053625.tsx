            ...
            {projects?.map((project, i) => (
                ...
                items-center justify-center   h-5 w-5 text-white-700 opacity-70" />
                    ...
                    <div className='flex flex-col'>
                        ...
                        etflix&apos;s user-friendly interface, personalized recommendations, and ability to binge-watch entire seasons have made it a go-to streaming platform for millions of people around the world, fundamentally changing the way we consume entertainment.
                        </p>
                    </div>
