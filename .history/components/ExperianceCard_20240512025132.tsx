...
function ExperienceCard({experience}: Props) {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-1 h-[550px] flex-shrink-0 w-[500px]
     md:w-[500px] xl:w-[700px] snap-center bg-[#292929] p-5 hover:opacity-100 opacity-40 
